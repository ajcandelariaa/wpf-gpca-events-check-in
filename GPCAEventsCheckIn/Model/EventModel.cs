...
namespace GPCAEventsCheckIn.Model
{
    public class EventModel
    {
        ...
        public static string EventBanner = "/GPCAEventsCheckIn;component/Assets/Images/Banners/img_2024_af.jpg";
        public static string BadgeBanner = "/GPCAEventsCheckIn;component/Assets/Images/Badges/img_2024_af.png";
