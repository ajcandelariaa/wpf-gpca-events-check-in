...
namespace GPCAEventsCheckIn.Model
{
    public class EventModel
    {
        ...
        public static string EventBanner = "/GPCAEventsCheckIn;component/Assets/Images/Banners/img_2024_glf.jpg";
        public static string BadgeBanner = "/GPCAEventsCheckIn;component/Assets/Images/Badges/img_2024_glf.jpg";
